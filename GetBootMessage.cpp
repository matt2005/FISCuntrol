...
void GetBootMessage::displayBootMessage()
{
  ...
  fisWriter.sendStringFS(0, 24, GreetingMessage1);
  fisWriter.sendStringFS(0, 32, GreetingMessage2); delay(5);
  fisWriter.sendStringFS(0, 40, GreetingMessage3); delay(5);
  fisWriter.sendStringFS(0, 48, GreetingMessage4); delay(5);
  fisWriter.sendStringFS(0, 56, GreetingMessage5); delay(5);
  fisWriter.sendStringFS(0, 64, GreetingMessage6); delay(5);
  fisWriter.sendStringFS(0, 72, GreetingMessage7); delay(5);
  fisWriter.sendStringFS(0, 80, GreetingMessage8); delay(5);
  delay(3500);
}
